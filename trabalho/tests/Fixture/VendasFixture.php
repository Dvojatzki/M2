...
class VendasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'clientes_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'produtos_id' => 1,
                'valor' => 1.5,
                'created' => '2022-11-08 00:49:58',
                'modified' => '2022-11-08 00:49:58',
            ],
        ];
        parent::init();
    }
